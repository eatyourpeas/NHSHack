...
Game.Two.prototype.update = function(){
    ...
    if (player.alive)
    {
        ...
        //  Run collision
        game.physics.arcade.overlap(bullets, aliens, function collisionHandler (bullet, alien) {
        ...
        game.physics.arcade.overlap(enemyBullets, player, function enemyHitsPlayer (player,bullet) {
...
Game.Two.prototype.create = function () {
    ...
    game.add.text(game.world.width -220, 10, 'Lives : ', { font: '34px Arial', fill: '#fff' });
